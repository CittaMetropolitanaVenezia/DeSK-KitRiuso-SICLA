...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.form.Panel": "ext/src/form/FormPanel.js",
  "Ext.locale.it.Component": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.form.Basic": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.form.CheckboxGroup": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.form.RadioGroup": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.form.field.Base": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.form.field.ComboBox": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.form.field.Date": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.form.field.HtmlEditor": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.form.field.Number": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.form.field.Text": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.form.field.Time": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.form.field.VTypes": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.grid.BooleanColumn": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.grid.DateColumn": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.grid.GroupingFeature": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.grid.NumberColumn": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.grid.PropertyColumnModel": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.grid.header.Container": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.grid.plugin.DragDrop": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.picker.Date": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.picker.Month": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.tab.Tab": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.toolbar.Paging": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.view.AbstractView": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.view.View": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
  "Ext.locale.it.window.MessageBox": "ext/packages/ext-locale/overrides/it/ext-locale-it.js",
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "SIO.Application": [],
  "SIO.controller.Admin": [],
  "SIO.controller.Login": [],
  "SIO.controller.Main": [],
  "SIO.controller.Submissions": [],
  ...
  "SIO.model.User": [],
  "SIO.proxy.Rest": [],
  "SIO.store.Attachments": [],
  "SIO.store.Opinions": [],
  "SIO.store.Submissions": [],
  "SIO.store.Towns": [],
  "SIO.store.Users": [],
  "SIO.util.Labels": [],
  "SIO.util.Logger": [],
  ...
  "SIO.ux.LeafletMap": [],
  "SIO.ux.Lightbox": [],
  "SIO.ux.form.field.ClearableComboBox": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "SIO.ux.form.field.ClearableComboBox": [
    "widget.clearablecombobox"
  ],
  "SIO.ux.form.field.ClearableTextfield": [
    "widget.clearabletextfield"
  ],
  "SIO.ux.form.field.HelpText": [
    "plugin.fieldhelptext"
  ],
  "SIO.ux.form.field.RestrictiveFile": [
    "widget.restfileupload"
  ],
  "SIO.ux.grid.plugin.HeaderFilters": [],
  "SIO.ux.panel.GlyphTool": [
    "widget.glyphtool"
  ...
  "SIO.view.admin.system.Form": [
    "widget.admin.system.form"
  ],
  "SIO.view.admin.towns.Grid": [
    "widget.admin.towns.grid"
  ],
  "SIO.view.admin.users.Grid": [
    "widget.admin.users.grid"
  ],
  "SIO.view.login.ChangePwd": [],
  "SIO.view.login.Form": [
    "widget.login.form"
  ...
  "SIO.view.submissions.Grid": [
    "widget.submissions.grid"
  ],
  "SIO.view.submissions.Map": [
    "widget.submissions.map"
  ],
  "SIO.view.submissions.StatusesFilterToolbar": [
    "widget.submissions.statusesfiltertoolbar"
  ],
  "SIO.view.submissions.TownsCombo": [
    "widget.submissions.townscombo"
  ],
  "SIO.view.submissions.TownsFilterToolbar": [
    "widget.submissions.townsfiltertoolbar"
  ],
  "SIO.view.submissions.UploadWindow": [
    "widget.submissions.uploadwindow"
  ],
  "SIO.view.submissions.detail.AttachmentsDataView": [
    "widget.submissions.detail.attachmentsdataview"
  ],
  "SIO.view.submissions.detail.OpinionsForm": [
    "widget.submissions.detail.opinionsform"
  ],
  "SIO.view.submissions.detail.OpinionsGrid": [
    "widget.submissions.detail.opinionsgrid"
  ],
  "SIO.view.submissions.detail.OpinionsHistoryGrid": [
    "widget.submissions.detail.opinionshistorygrid"
  ],
  "SIO.view.submissions.detail.Panel": [
    "widget.submissions.detail.panel"
  ],
  "SIO.view.submissions.detail.ProvinceNote": [
    "widget.submissions.detail.provincenote"
  ],
  "SIO.view.submissions.edit.DataVIew": [
    "widget.submissions.edit.dataview"
  ],
  "SIO.view.submissions.edit.Form": [
    "widget.submissions.edit.form"
  ],
  "SIO.view.submissions.edit.Grid": [
    "widget.submissions.edit.grid"
  ],
  "SIO.view.submissions.edit.Panel": [
    "widget.submissions.edit.panel"
  ],
  "SIO.view.submissions.edit.UploadForm": [
    "widget.submissions.edit.uploadform"
  ]
});
Ext.setVersion("ext-locale", "1.0.0");
Ext.setVersion("ext-sio-theme", "1.0.0");
...
Ext.Loader.loadScript("ext/packages/ext-locale/overrides/it/ext-locale-it.js");;
